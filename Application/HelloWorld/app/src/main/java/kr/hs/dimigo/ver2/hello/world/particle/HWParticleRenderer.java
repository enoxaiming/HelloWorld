...
import kr.hs.dimigo.ver2.hello.world.HWApplication;
import kr.hs.dimigo.ver2.hello.world.R;
import timber.log.Timber;

public class HWParticleRenderer implements GLSurfaceView.Renderer {
    public float ratio;
    ...
    private HWParticleSystem mParticleSystem;
    ...
    public HWParticleRenderer(GLSurfaceView glSurfaceView) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(HWApplication.getContext(), R.raw.star_vert);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(HWApplication.getContext(), R.raw.star_frag);
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        mExecutor.execute(new HWParticlesGenerator(this));
    }
    ...
    public void logFrame() {
        ...
        if(timePassed >= 10_000) {
            Timber.d("fps %d @ %d stars || %f", frames / 10, HWParticleSystem.PARTICLE_COUNT, mTime);
            frames = 0;
    ...
    public HWParticleSystem getParticleSystem() {
        return mParticleSystem;
    }

    public void setParticleSystem(final HWParticleSystem particleSystem) {
