...
public class GlobeView extends View
{
	...
	public void setAnimationDelegate(AnimationDelegate delegate)
	{
	...
	public native Point3d pointOnSphereFromScreen(Point2d screenPt,Matrix4d viewModelMatrix,Point2d frameSize,boolean clip);
